...
-- CreateIndex
CREATE UNIQUE INDEX "GenericPage_navbarItemId_key" ON "GenericPage"("navbarItemId");

-- CreateIndex
CREATE INDEX "GenericPage_region_status_idx" ON "GenericPage"("region", "status");

-- CreateIndex
CREATE UNIQUE INDEX "GenericPage_navbarItemId_region_key" ON "GenericPage"("navbarItemId", "region");
...
-- AddForeignKey
ALTER TABLE "GenericPage" ADD CONSTRAINT "GenericPage_navbarItemId_fkey" FOREIGN KEY ("navbarItemId") REFERENCES "NavbarItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
