...
export function GenericPageView({ genericPage }: GenericPageViewProps) {
  ...
  return (
    <section className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 py-12">
      <div className="rounded-3xl border border-zinc-100 bg-gradient-to-br from-green-50 via-white to-slate-50 p-10 shadow-sm">
            ...
            {editorData ? (
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: genericPage.content as string,
                }}
              />
            )}
          </div>
