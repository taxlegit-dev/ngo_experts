...
const features = [
  {
    ...
    link: "https://aarambh.ngoexperts.com/checkname",
  },
  {
    ...
    link: "https://aarambh.ngoexperts.com/",
  },
  {
  ...
  return (
    <section className="relative overflow-hidden py-8">
      ...
      <div className="absolute inset-0">
        <div className="h-72 bg-gradient-to-b from-[#ecf8e8] via-[#d9f4cd] to-[#eef8ea] rounded-b-[56px]" />
      </div>
