      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16 text-center">
          <h2 className="mt-4 text-4xl font-extrabold text-gray-900">
            Heart Behind NGO Experts
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-gray-600">
            At NGO Experts, our leadership drives innovation, transparency, and
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  Ashutosh leads NGO Experts with a strong vision to simplify
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  solutions to deliver seamless experiences for NGO Experts
                  clients.
                </p>
