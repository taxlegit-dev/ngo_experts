...
export const refundPolicyData = {
  title: "Refund Policy",
  subtitle:
    "At NGO Experts, we understand that dealing with the legal compliance of business set-up and tax can be challenging. Our mission is to provide clear, reliable tax and compliance services that make your business journey hassle-free.",
  ...
  introduction: (
    <>
      ...
      <p className="text-gray-800 leading-relaxed">
        ...
        terms. With NGO Experts, your satisfaction is guaranteed.
      </p>
    </>
  ),
