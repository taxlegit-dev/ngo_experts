      ...
      <div ref={wrapperRef} className="relative">
        <div className="mx-auto flex h-[70px]  items-center justify-between gap-4 px-8 sm:px-6">
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="md:hidden rounded-md border border-green-200 bg-white/80 px-3 py-2 text-[20px] font-bold text-green-700 shadow-sm backdrop-blur hover:bg-white"
                            ...
                            {group.items.map((subItem) => (
                              <li key={subItem.id}>
                                <Link
                                  ...
                                  className="block rounded-lg px-3 py-2 text-[14px] font-medium text-zinc-700 transition hover:bg-[#dff4d2] hover:text-black"
                                >
                                  {subItem.label}
                                </Link>
                              </li>
        ...
        {isMobileMenuOpen && (
          <>
            ...
            {/* Drawer */}
            <div className="fixed right-0 top-[110px] z-[999] h-[calc(100vh-110px)] w-full overflow-hidden bg-gradient-to-b from-[#dff4d2] to-[#eef8ea] md:hidden">
                                ...
                                {group.items.map((sub) => (
                                  <li key={sub.id} className="list-none">
                                    <Link
                                      ...
                                      onClick={handleMobileNavClick}
                                      className="block rounded-lg px-3 py-2 text-[13px] font-medium text-zinc-800 hover:bg-[#dff4d2]"
                                    >
                                      {sub.label}
                                    </Link>
                                  </li>
