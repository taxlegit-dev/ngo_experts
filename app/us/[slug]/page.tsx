...
export async function generateMetadata({
  ...
  // Build base URL
  const baseUrl = "https://ngoexperts.com";
  const pageUrl = `${baseUrl}/us/${slug}`;
  const defaultTitle = `${navbarItem.label} | NGO Experts US`;
  const defaultDescription = `Learn more about ${navbarItem.label} services at NGO Experts US`;
