...
export async function generateMetadata({
  ...
  const canonical = `https://ngoexperts.com/${slug}`;
  const defaultTitle = `${navbarItem.label} | NGO Experts`;
  const defaultDescription = `Learn more about ${navbarItem.label} services at NGO Experts`;
